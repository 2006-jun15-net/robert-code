...
namespace ProceduralBasics
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // int x = 5; // declares a variable named "x" with type "int" (integer, whole number), and gives it the value 5.
            ...
            // collections
            //      arrays
            //          ing[], double[], string[], anything you want
            ...
            {
                // Get the "i-th" number of the array
